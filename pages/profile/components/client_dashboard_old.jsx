    ...
    render_dashboard(){
        ...
        return(
            <div className="w-full p-3">
                <div className="flex w-auto gap-4 align-items-center" style={{left:"0px", width:"100vw"}}>
                    <h4>{this.state.client.fantasia}</h4>
                    <h5 style={{color:"var(--text-c)"}}>{this.state.client.razao_social}</h5>
                </div>
                {/* {this.render_dashboard()} */}
                <Accordion multiple activeIndex={[0]}>

                    <AccordionTab header="Dashboard">
                        ...
                        <div className="flex gap-2 w-full overflow-x-scroll">
                            {this.state.client_products.map((i,key)=>{
                                return(<div key={i.PRODUTO_ID+key}className={"flex flex-wrap w-min h-auto mb-2 p-1 border-round-md align-items-start "+ (this.state.selected_product?.id == i.PRODUTO_ID?"bg-black-alpha-20" : "bg-white-alpha-10")}>
                                    ...
                                    >
                                        <ProductIcon size={8} item={i.PRODUTO_ID}/>
                                    </Button>
                                    <label className={"text-sm mt-2 " + (this.state.selected_product?.id == i.PRODUTO_ID?"text-primary-500" : "text-white")}>{i.PRODUTO_NOME}</label>
                                </div>)
                            })}
                        </div>
                        ...
                        <div className="flex w-full h-auto">
                            <BarChart
                                ...
                                onSelect={(selected_order,callback)=>{
                                    this.setState({selected_order},()=>{callback?.()})
                                }}
                                onItemSelect={(item)=>{
                                    console.log(item)
                                    this.setState({selected_order:item})
                                }}
                            />
                        </div>
                        ...
                        <div className="flex w-full flex-grow-1 field sm:col-12 md:col-6 lg:col-4 chart-container">
                            
                                {this.state.selected_order &&
                                <div className="flex p-fluid h-full grid formgrid col-12">
                                    <div className="flex flex-grow-1 sm:col-12 md:col-6 lg:col-4 align-items-center">
                                    <PieChart order={this.state.selected_order}/>
                                    </div>
                                    <div className="flex flex-grow-1 sm:col-12 md:col-6 lg:col-8">
                                    <DataTable
                                        scrollable
                                        scrollHeight="460px"
                    ...
                    <AccordionTab header="Chamado">
                        <div className="flex p-fluid grid formgrid col-12">
                            <CallDialog
                                fullScreen
                    ...
                    <AccordionTab header="Pedidos">
                        <Accordion multiple activeIndex={[0]}>
                            ...
                            <AccordionTab header="Itens Comprados">
                                {/* <ProductCard item={this.state.client_products?.[0]}/> */}
                    ...
                    <AccordionTab header="Financeiro">
                    </AccordionTab>
